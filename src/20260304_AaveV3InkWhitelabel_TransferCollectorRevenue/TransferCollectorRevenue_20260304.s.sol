...
/**
 * @dev Deploy Ink
 * deploy-command: make deploy-ledger contract=src/20260304_AaveV3InkWhitelabel_TransferCollectorRevenue/TransferCollectorRevenue_20260304.s.sol:DeployInk chain=ink
 * verify-command: FOUNDRY_PROFILE=deploy npx catapulta-verify -b broadcast/TransferCollectorRevenue_20260304.s.sol/57073/run-latest.json
 */
contract DeployInk is InkScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3InkWhitelabel_TransferCollectorRevenue_20260304).creationCode
    );
