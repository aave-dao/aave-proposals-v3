...
contract AaveV3Optimism_OracleDeprecationForLongTailAssets_20260915 is AaveV3PayloadOptimism {
  ...
  address public immutable LUSD_PRICE_FEED =
    deployPriceAdapter(LUSD_PRICE_USD, address(AaveV3Optimism.ACL_MANAGER), address(0), 'LUSD');
  uint256 public constant MAI_PRICE_USD = 95300000;
  address public immutable MAI_PRICE_FEED =
    deployPriceAdapter(MAI_PRICE_USD, address(AaveV3Optimism.ACL_MANAGER), address(0), 'MAI');
  uint256 public constant sUSD_PRICE_USD = 30290000;
  address public immutable sUSD_PRICE_FEED =
    deployPriceAdapter(sUSD_PRICE_USD, address(AaveV3Optimism.ACL_MANAGER), address(0), 'sUSD');
