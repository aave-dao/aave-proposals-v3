...
author: "LlamaRisk"
discussions: "https://governance.aave.com/t/arfc-oracle-deprecation-for-long-tail-assets-across-aave-v2-and-v3/25400"
...
Previously applied as part of [Aave V2 Continued Deprecation Steps](https://governance.aave.com/t/arfc-continued-deprecation-steps-of-aave-v2-markets/24351), this round of changes expands to some of the Aave V3 deployments, as these assets have already been deprecated for an extended period of time and continue to experience a decline in adoption, which in turn affects the stability of the secondary market price feeds employed by Chainlink. Deprecating troubled or inactive reserves is a standard, well-established part of Aave governance. The same process has been applied to other assets before, including the [full deprecation of DPI across Aave deployments](https://governance.aave.com/t/direct-to-aip-full-deprecation-of-dpi-across-aave-deployments/23212) and the [TUSD offboarding plan](https://governance.aave.com/t/arfc-tusd-offboarding-plan/14008), and this proposal follows the same playbook.
...
[The active feed](https://celoscan.io//address/0xdCdA3E7E90fe827776b8FDaEa3C5977F123354DA#code) is a Chainlink USDm/USD price feed with the stable cap adapter clamped at the $1.04 reference, while the current oracle price is at $1.00. Hardcoding the oracle to the reference value removes the upward-manipulation vector for the residual debt without affecting current positions.
...
AMPL is Ampleforth's rebasing, elastic-supply token. [Its price feed](https://etherscan.io/address/0x492575FDD11a0fCf2C6C719867890a7648d526eB) is a Chainlink AMPL/ETH aggregator that prices the rebase-adjusted unit. On Aave V2 Ethereum it carries $1.66M of supply across 1004 wallets and $2.60M of debt across 34 wallets. None of the supplied balance is enabled as collateral, as the reserve LT is already zero. The reserve's history is documented in the [AMPL problem on Aave V2 Ethereum](https://governance.aave.com/t/ampl-problem-on-aave-v2-ethereum/15886) governance thread: a 2021 utilization spiral left the pool effectively fully in bad debt, partially settled through a later repayment, and the collateral side was previously addressed through a Merkl distribution to remaining suppliers. The treasury Collector itself holds 98% of the remaining supply.
...
## Specification (updated September 16th, 2026)
...
| ----- | --------------------- | ------------- | ----------------------- |
| LUSD  | Aave V3 Ethereum Core | $1.01         | $1.00                   |
...
| ----- | --------------------- | ------------- | ----------------------- | ------------ |
| RPL   | Aave V3 Ethereum Core | $1.6172       | $1.7338                 | USD          |

#### Aave V2

| Asset | Instance         | Current Price | Recommended Fixed Price | Denomination |
| ----- | ---------------- | ------------- | ----------------------- | ------------ |
| AMPL  | Aave V2 Ethereum | $1.1955       | $1.2396                 | ETH          |
| RAI   | Aave V2 Ethereum | $2.9495       | $2.6587                 | ETH          |
| sUSD  | Aave V2 Ethereum | $0.3780       | $0.3780                 | ETH          |
| YFI   | Aave V2 Ethereum | $2,015.8260   | $2,286.6368             | ETH          |
...
| Asset   | Instance                 | Current Price | Recommended Fixed Price |
| ------- | ------------------------ | ------------- | ----------------------- |
| MAI     | Aave V3 Arbitrum         | $0.9530       | $0.9530                 |
| FRAX    | Aave V3 Avalanche        | $0.9911       | $1.0000                 |
| MAI     | Aave V3 Avalanche        | $0.9530       | $0.9530                 |
| BAL     | Aave V3 Ethereum Core    | $0.1092       | $0.1337                 |
| FXS     | Aave V3 Ethereum Core    | $0.2582       | $0.3562                 |
| KNC     | Aave V3 Ethereum Core    | $0.1325       | $0.1400                 |
| STG     | Aave V3 Ethereum Core    | $0.1478       | $0.2734                 |
| FRAX    | Aave V3 Ethereum EtherFi | $0.9910       | $1.0000                 |
| LUSD    | Aave V3 Optimism         | $1.0096       | $1.0000                 |
| MAI     | Aave V3 Optimism         | $0.9530       | $0.9530                 |
| sUSD    | Aave V3 Optimism         | $0.3029       | $0.3029                 |
| BAL     | Aave V3 Polygon          | $0.1095       | $0.1316                 |
| GHST    | Aave V3 Polygon          | $0.0640       | $0.0828                 |
| miMATIC | Aave V3 Polygon          | $0.9530       | $0.9530                 |
| SCR     | Aave V3 Scroll           | $0.0209       | $0.0335                 |

#### Aave V2

| Asset | Instance         | Current Price | Recommended Fixed Price | Denomination |
| ----- | ---------------- | ------------- | ----------------------- | ------------ |
| BAL   | Aave V2 Ethereum | $0.1100       | $0.1317                 | ETH          |
| ENJ   | Aave V2 Ethereum | $0.0247       | $0.0461                 | ETH          |
| KNC   | Aave V2 Ethereum | $0.1352       | $0.1401                 | ETH          |
| REN   | Aave V2 Ethereum | $0.0033       | $0.0033                 | ETH          |
| ZRX   | Aave V2 Ethereum | $0.1090       | $0.0981                 | ETH          |
| BAL   | Aave V2 Polygon  | $0.1097       | $0.1284                 | ETH          |
| GHST  | Aave V2 Polygon  | $0.0641       | $0.0793                 | ETH          |
...
| ----- | --------------------- | ---------- | ------ |
| LUSD  | Aave V3 Ethereum Core | 20%        | 100%   |
| FRAX  | Aave V3 Ethereum Core | 20%        | 100%   |
| RPL   | Aave V3 Ethereum Core | 20%        | 100%   |
| LUSD  | Aave V3 Arbitrum      | 50%        | 100%   |
| FRAX  | Aave V3 Arbitrum      | 20%        | 100%   |
| USDm  | Aave V3 Celo          | 15%        | 100%   |
...
**September 16th, 2026.** The specification was refreshed ahead of the AIP. The analysis sections above are left as published on July 29th, 2026 and describe the state at that date.

- Freeze status, supply and borrow caps, reserve factors and interest rate model parameters listed as current values in the specification were re-verified on-chain on September 16th, 2026 and are unchanged.
- The reserve factor target for the six V3 reserves in the Reserve Factor Adjustment table is 100% rather than 99%. The 99% figure was a precaution against a historical issue with 100% reserve factors that does not apply to the current Aave V3 pool implementation, on which GHO on Aave V3 Ethereum Core already runs with a 100% reserve factor.
- The Current Price columns of the oracle tables are updated to the on-chain oracle values of September 16th, 2026, and the fixed prices are recomputed with the same rules over the trailing 6 month window ending on that date. For the Aave V2 feeds, which report in ETH, the trailing average is taken over the feed value expressed in USD at each round, converting at the contemporaneous ETH/USD price. ETH/USD stood at $2,397.95 on September 16th, 2026 against $1,910.56 at publication.
- MAI on Aave V3 Arbitrum, Avalanche and Optimism and miMATIC on Aave V3 Polygon now trade 4.7% below their dollar peg, outside the 3% band, so they take the depegged treatment and are fixed at the current feed value instead of $1.00. sUSD on Aave V2 Ethereum and Aave V3 Optimism keep the same treatment at their current feed values.
- BAL on Aave V3 Ethereum Core and BAL, GHST and miMATIC on Aave V3 Polygon were listed in the freeze and interest rate model tables but missing from the oracle tables. They are added to the Negligible Exposure Oracle Adjustment table with the same treatment as the other reserves in that group.
- Since publication, AMPL debt on Aave V2 Ethereum has grown from $2.60M to $3.72M through interest accrual at the current 317% borrow rate, which the interest rate model flattening in this proposal stops.

Fixed prices that differ from the published specification:

| Asset   | Instance              | Published Fixed Price | Updated Fixed Price | Current Price |
| ------- | --------------------- | --------------------- | ------------------- | ------------- |
| RPL     | Aave V3 Ethereum Core | $1.9543               | $1.7338             | $1.6172       |
| AMPL    | Aave V2 Ethereum      | $1.1742               | $1.2396             | $1.1955       |
| RAI     | Aave V2 Ethereum      | $2.7339               | $2.6587             | $2.9495       |
| sUSD    | Aave V2 Ethereum      | $0.2952               | $0.3780             | $0.3780       |
| YFI     | Aave V2 Ethereum      | $2,396.8163           | $2,286.6368         | $2,015.8260   |
| MAI     | Aave V3 Arbitrum      | $1.0000               | $0.9530             | $0.9530       |
| MAI     | Aave V3 Avalanche     | $1.0000               | $0.9530             | $0.9530       |
| BAL     | Aave V3 Ethereum Core | not listed            | $0.1337             | $0.1092       |
| FXS     | Aave V3 Ethereum Core | $0.5415               | $0.3562             | $0.2582       |
| KNC     | Aave V3 Ethereum Core | $0.1472               | $0.1400             | $0.1325       |
| STG     | Aave V3 Ethereum Core | $0.2666               | $0.2734             | $0.1478       |
| MAI     | Aave V3 Optimism      | $1.0000               | $0.9530             | $0.9530       |
| sUSD    | Aave V3 Optimism      | $0.2763               | $0.3029             | $0.3029       |
| BAL     | Aave V3 Polygon       | not listed            | $0.1316             | $0.1095       |
| GHST    | Aave V3 Polygon       | not listed            | $0.0828             | $0.0640       |
| miMATIC | Aave V3 Polygon       | not listed            | $0.9530             | $0.9530       |
| SCR     | Aave V3 Scroll        | $0.0418               | $0.0335             | $0.0209       |
| BAL     | Aave V2 Ethereum      | $0.1424               | $0.1317             | $0.1100       |
| ENJ     | Aave V2 Ethereum      | $0.0372               | $0.0461             | $0.0247       |
| KNC     | Aave V2 Ethereum      | $0.1356               | $0.1401             | $0.1352       |
| ZRX     | Aave V2 Ethereum      | $0.0966               | $0.0981             | $0.1090       |
| BAL     | Aave V2 Polygon       | $0.1405               | $0.1284             | $0.1097       |
| GHST    | Aave V2 Polygon       | $0.0867               | $0.0793             | $0.0641       |

## References

- Implementation: [AaveV2Ethereum](https://github.com/aave-dao/aave-proposals-v3/blob/main/src/20260915_Multi_OracleDeprecationForLongTailAssets/AaveV2Ethereum_OracleDeprecationForLongTailAssets_20260915.sol), [AaveV2Polygon](https://github.com/aave-dao/aave-proposals-v3/blob/main/src/20260915_Multi_OracleDeprecationForLongTailAssets/AaveV2Polygon_OracleDeprecationForLongTailAssets_20260915.sol), [AaveV3Arbitrum](https://github.com/aave-dao/aave-proposals-v3/blob/main/src/20