...
| ------------------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| stkAAVE            | [0x4da27a545c0c5B758a6BA100e3a049001de870f5](https://etherscan.io/address/0x4da27a545c0c5B758a6BA100e3a049001de870f5) | currentAllowance + 50,500 / 4 + emissionPerSecond x (block.timestamp - snapshot + 90 days) |
...
The new stkAAVE allowance is computed at execution time as the sum of the allowance read at execution, one quarter of the 50,500 AAVE backlog gap measured at the snapshot (claims between snapshot and execution reduce the allowance read at execution by the same amount, so no already-claimed rewards are double counted), the accrual since the snapshot timestamp (1787791523) and 90 days of forward emissions, both read on-chain from the stkAAVE emission configuration.
